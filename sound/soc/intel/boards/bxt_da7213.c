/*
 * Intel Broxton I2S Machine Driver for DA7213
 *
...
#define BXT_DIALOG_CODEC_DAI	"da7213-hifi"
	...
	struct snd_kcontrol *k, int  event)
{
	...
	if (SND_SOC_DAPM_EVENT_OFF(event)) {
		...
		ret = snd_soc_dai_set_sysclk(codec_dai,
                        DA7213_CLKSRC_MCLK, 19200000, SND_SOC_CLOCK_IN);
		if (ret)
			dev_err(card->dev, "can't set codec sysclk configuration\n");

		ret = snd_soc_dai_set_pll(codec_dai, 0,
					  DA7213_SYSCLK_PLL_SRM, 0,
...
static int broxton_da7213_codec_init(struct snd_soc_pcm_runtime *rtd)
{
...
static int broxton_da7213_fe_init(struct snd_soc_pcm_runtime *rtd)
{
...
static const struct snd_soc_ops broxton_da7213_fe_ops = {
...
static struct snd_soc_dai_link broxton_dais[] = {
	...
	[BXT_DPCM_AUDIO_PB] =
	{
		...
		.nonatomic = 1,
		.init = broxton_da7213_fe_init,
		.trigger = {
			SND_SOC_DPCM_TRIGGER_POST, SND_SOC_DPCM_TRIGGER_POST},
		.dpcm_playback = 1,
		.ops = &broxton_da7213_fe_ops,
	},
	[BXT_DPCM_AUDIO_CP] =
	{
	...
	/* Back End DAI links */
	{
		...
		.init = broxton_da7213_codec_init,
...
/* broxton audio machine driver for da7213 */
...
/* Module information */
MODULE_DESCRIPTION("Audio Machine driver-DA7213 I2S mode");
MODULE_AUTHOR("Pierre-Louis Bossart <pierre-louis.bossart@linux.intel.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("platform:bxt_da7213_i2s");
