...
static const struct snd_soc_acpi_link icl_rvp[] = {
	{
		.mask = BIT(0),
		.dev_num = ARRAY_SIZE(rt700_0_adr),
		.adr = rt700_0_adr,
	},
	{}
};
...
static const struct snd_soc_acpi_link icl_3_in_1_default[] = {
	{
		.mask = BIT(0),
...
static const struct snd_soc_acpi_link icl_3_in_1_mono_amp[] = {
	{
		.mask = BIT(0),
		.dev_num = ARRAY_SIZE(rt711_0_adr),
		.adr = rt711_0_adr,
