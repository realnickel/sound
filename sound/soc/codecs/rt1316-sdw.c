...
static int rt1316_io_init(struct device *dev, struct sdw_slave *slave)
{
	...
	regmap_write(rt1316->regmap, 0xc00b, 0x20);
	...
	regmap_write(rt1316->regmap, 0x3004, 0xd4);
	regmap_write(rt1316->regmap, 0x3005, 0xf6);
	regmap_write(rt1316->regmap, 0xc007, 0x44);
	regmap_write(rt1316->regmap, 0xc008, 0x44);
	regmap_write(rt1316->regmap, 0xc009, 0x33);
	regmap_write(rt1316->regmap, 0xc007, 0x11);
	regmap_write(rt1316->regmap, 0xc008, 0x11);
	regmap_write(rt1316->regmap, 0xc009, 0x00);
