...
static int graph_probe(struct platform_device *pdev)
{
	...
	dai_props = devm_kzalloc(dev, li.link * sizeof(*dai_props), GFP_KERNEL);
	dai_link  = devm_kzalloc(dev, li.link * sizeof(*dai_link),  GFP_KERNEL);
	dais      = devm_kzalloc(dev, li.dais * sizeof(*dais),      GFP_KERNEL);
	cconf     = devm_kzalloc(dev, li.conf * sizeof(*cconf),     GFP_KERNEL);
