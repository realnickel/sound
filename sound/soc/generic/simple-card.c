...
static int asoc_simple_card_probe(struct platform_device *pdev)
{
	...
	dai_props = devm_kzalloc(dev, lnum * sizeof(*dai_props), GFP_KERNEL);
	dai_link  = devm_kzalloc(dev, lnum * sizeof(*dai_link),  GFP_KERNEL);
	dais      = devm_kzalloc(dev, dnum * sizeof(*dais),      GFP_KERNEL);
	cconf     = devm_kzalloc(dev, cnum * sizeof(*cconf),     GFP_KERNEL);
