...
/*
 * DAI hardware clock providers/followers
 *
 * This is wrt the codec, the inverse is true for the interface
 * i.e. if the codec is clk and FRM provider then the interface is
 * clk and frame follower.
 */
#define SND_SOC_DAIFMT_CBP_CFP		(1 << 12) /* codec clk provider & frame provider */
#define SND_SOC_DAIFMT_CBF_CFP		(2 << 12) /* codec clk follower & frame provider */
#define SND_SOC_DAIFMT_CBP_CFF		(3 << 12) /* codec clk provider & frame follower */
#define SND_SOC_DAIFMT_CBF_CFF		(4 << 12) /* codec clk follower & frame follower */

/* previous definitions kept for backwards-compatibility, do not use in new contributions */
#define SND_SOC_DAIFMT_CBM_CFM		SND_SOC_DAIFMT_CBP_CFP
#define SND_SOC_DAIFMT_CBS_CFM		SND_SOC_DAIFMT_CBF_CFP
#define SND_SOC_DAIFMT_CBM_CFS		SND_SOC_DAIFMT_CBP_CFF
#define SND_SOC_DAIFMT_CBS_CFS		SND_SOC_DAIFMT_CBF_CFF
