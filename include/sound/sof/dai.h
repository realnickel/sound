...
#define SOF_DAI_FMT_CBF_CFP	(2 << 12) /**< codec bclk follower & frame provider */
#define SOF_DAI_FMT_CBP_CFF	(3 << 12) /**< codec bclk provider & frame follower */
#define SOF_DAI_FMT_CBF_CFF	(4 << 12) /**< codec bclk follower & frame follower */

/* keep old definitions for backwards compatibility */
#define SOF_DAI_FMT_CBM_CFM	SOF_DAI_FMT_CBP_CFP
#define SOF_DAI_FMT_CBS_CFM	SOF_DAI_FMT_CBF_CFP
#define SOF_DAI_FMT_CBM_CFS	SOF_DAI_FMT_CBP_CFF
#define SOF_DAI_FMT_CBS_CFS	SOF_DAI_FMT_CBF_CFF
