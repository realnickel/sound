...
sdw_get_device_id(struct sdw_slave *slave, struct sdw_slave_driver *drv)
{
...
static int sdw_bus_match(struct device *dev, struct device_driver *ddrv)
{
	...
	struct sdw_slave_driver *drv = drv_to_sdw_slave_driver(ddrv);
...
{
	struct sdw_slave *slave = dev_to_sdw_dev(dev);
	struct sdw_slave_driver *drv = drv_to_sdw_slave_driver(dev->driver);
